...
public class EditarAvaliacao extends javax.swing.JFrame implements TelaAntecedente {
    private final Main tela;
    private Paciente paciente = null;
    private Profissional fisioterapeuta = null;
    private final Avaliacao avaliacao;

    public EditarAvaliacao(Main tela, Avaliacao a) {
        initComponents();
        ...
        this.tela = tela;
        this.avaliacao = a;
        this.setTitle("Editar Avaliação");
        ...
        tCodigoFisioterapeuta.setDisabledTextColor(Color.gray);
        tCodigoFisioterapeuta.setBorder(BorderFactory.createLineBorder(Color.gray));
        tCodigoFisioterapeuta.setBackground(Color.decode("#F7F7F7"));
        // set fields
        tNomePaciente.setText(a.getPaciente().getNome());
        tCodigoPaciente.setText(Integer.toString(a.getPaciente().getId()));
        tNomeFisioterapeuta.setText(a.getFisioterapeuta().getUsuario().getNome());
        tCodigoFisioterapeuta.setText(Integer.toString(a.getFisioterapeuta().getId()));
        tMedico.setText(a.getMedico());
        tDiagnosticoClinico.setText(a.getDiagnosticoClinico());
        tDiagnosticoFisico.setText(a.getDiagnosticoFisio());
        tData.setText(Formatacao.date2StringScreen(this.avaliacao.getDataAvaliacao()));
    }
    ...
    private void initComponents() {
        ...
        tDiagnosticoFisico = new javax.swing.JTextArea();
        ...
        jLabel17.setText("Diagnóstico Físico");
        ...
        tDiagnosticoFisico.setColumns(20);
        tDiagnosticoFisico.setRows(5);
        jScrollPane2.setViewportView(tDiagnosticoFisico);
                                ...
                                .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(inputLayout.createSequentialGroup()
                                        ...
                                        .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(tCodigoFisioterapeuta, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(0, 0, Short.MAX_VALUE))))))
                    .addGroup(inputLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        inputLayout.setVerticalGroup(
            ...
            .addGroup(inputLayout.createSequentialGroup()
                ...
                .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tCodigoFisioterapeuta, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bSalvarAvaliacaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bSalvarAvaliacaoMouseClicked
        if (!Validacao.dateIsValid(tData.getText())) {
            ...
            if(this.fisioterapeuta != null)
                this.avaliacao.setFisioterapeuta(this.fisioterapeuta);
            if(this.paciente!=null)
                this.avaliacao.setPaciente(this.paciente);
            this.avaliacao.setDataAvaliacao(Formatacao.string2Date(tData.getText()));
            this.avaliacao.setMedico(tMedico.getText());
            this.avaliacao.setDiagnosticoClinico(tDiagnosticoClinico.getText());
            this.avaliacao.setDiagnosticoFisio(tDiagnosticoFisico.getText());
            AvaliacaoController ac = new AvaliacaoController();
            if(ac.editar(this.avaliacao)){
    ...
    private javax.swing.JTextArea tDiagnosticoFisico;
