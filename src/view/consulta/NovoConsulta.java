...
public class NovoConsulta extends javax.swing.JFrame implements TelaAntecedente {
    private final Main tela;
    private Paciente paciente = null;
    private final ProcedimentoController pc = new ProcedimentoController();

    public NovoConsulta(Main tela) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setForeground(new java.awt.Color(211, 0, 0));
        jLabel14.setText("*");
        jLabel14.setMaximumSize(new java.awt.Dimension(5, 20));
        jLabel14.setMinimumSize(new java.awt.Dimension(5, 20));
        jLabel14.setPreferredSize(new java.awt.Dimension(5, 20));
                    ...
                    .addGroup(inputLayout.createSequentialGroup()
                        ...
                        .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(inputLayout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(inputLayout.createSequentialGroup()
                                .addComponent(tQuantidade, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
